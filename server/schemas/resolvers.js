...
const resolvers = {
  ...
  Mutation: {
      addUser: async (parent,{firstName,lastName,email,password,age,city,level,drink,smoke}) => {
      const user = await User.create({firstName,lastName,email,password,age,city,level,drink,smoke});
